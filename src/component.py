...
class Component(ComponentBase):
    ...
    def run(self):
        ...
        if self.params.endpoint == "investments":
            ...
            if len(in_tables) != 2:
                raise UserException("Investments endpoints needs 2 tables in input mapping: "
            ...
            self.import_investments_ui_data(entity_id=self.params.entity_id,
                                            client_reporting_period_id=self.params.client_reporting_period_id,
            ...
            endpoint_to_method[self.params.endpoint](entity_id=self.params.entity_id,
                                                     client_reporting_period_id=self.params.client_reporting_period_id,
                                                     data=data)
    ...
    def import_franchises_ui_data(self, entity_id, client_reporting_period_id, data):
    ...
    def import_investments_ui_data(
        self, entity_id: int, client_reporting_period_id: int, investments_data: list, finance_data: list
    ):
    ...
    def import_water_storage_ui_data(self, entity_id: int, client_reporting_period_id: int, data: list):
    ...
    def import_non_compliance_ui_data(self, entity_id: int, client_reporting_period_id: int, data: list):
    ...
    def import_locations_ui_data(self, entity_id: int, client_reporting_period_id: int, data: list):
        processed_data = []
        for row in data:
            location_entry = {
                "location": row["location"],
